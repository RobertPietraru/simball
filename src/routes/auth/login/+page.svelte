...
>
	...
	<div class="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
		...
		/>
		<div class="relative z-20 flex items-center text-lg font-medium">Enroute</div>
		<div class="relative z-20 mt-auto">
			<blockquote class="space-y-2">
				<p class="text-lg">
					&ldquo;Această aplicație mă ajută să-mi gestionez clienții în mod eficient. Este
					perfectă pentru activitatea mea de agent de vânzări!&rdquo;
				</p>
	...
	<div class="lg:p-8">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				<h1 class="text-2xl font-semibold tracking-tight">Autentificare</h1>
				<p class="text-sm text-muted-foreground">Introduceți emailul și parola pentru a vă autentifica</p>
			</div>
			...
			<div class="grid gap-6">
				...
				<div class="relative">
					...
					<div class="relative flex justify-center text-xs uppercase">
						<span class="bg-background px-2 text-muted-foreground">Sau, daca nu ai cont</span>
					</div>
				</div>
				<Button variant="outline" type="button" href="/auth/register">Înregistrează-te</Button>
			</div>
